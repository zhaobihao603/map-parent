package com.imap.cloud.common.cache;
...
import com.imap.cloud.common.util.ProtoStuffSerializerUtil;
...
public class RedisCache {
	...
	public <T> List<T> getListCache(final String key, Class<T> targetClass) {
		...
		return result == null?null:ProtoStuffSerializerUtil.deserializeList(result, targetClass);
	}
